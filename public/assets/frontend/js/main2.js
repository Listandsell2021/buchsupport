(function($) {
    ...
    var $owl = $('.gallery-book .owl-carousel');
...
$(document).on('click', '.gallery-book .owl-item>div', function() {
  // see https://owlcarousel2.github.io/OwlCarousel2/docs/api-events.html#to-owl-carousel
  var $speed = 300;  // in ms
  $owl.trigger('.gallery-book to.owl.carousel', [$(this).data( 'position' ), $speed] );
});
    // ------------------------------ GALLERY_CAROUSEL END -------------------------------------------------
   ...
   //  $( ".owl-next").html('<img src="assets/img/product/fashion-colorful/right-arrow.jpg" />');
   // $( ".owl-prev").html('<img src="assets/img/product/fashion-colorful/right-arrow-1.jpg" />');
    /* testimonials active */
