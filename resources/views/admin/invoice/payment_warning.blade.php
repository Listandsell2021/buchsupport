...
@section('content')
    ...
    <div class="invoice-box-content m-b-75">
        ...
        <div class="payment-reminder-desc">
            {!! getSettingTemplate($setting['payment_warning_text'], [
                ...
                'current_date' => getDateInGermany(getCurrentDate()),
                'invoice_price' => getCurrencyPrice($invoice->total),
                'invoice_price_with_charge' => getCurrencyPrice(getInvoicePriceWithCharge($invoice->total)),
