<template>
    <div class="vs-column-filter">
        ...
        <div class="dropdown">
            ...
            <Transition>
                <div class="dropdown-menu dropdown-menu-right vs-filter-dropdown-menu" v-on-click-outside="onClickOutsideHandler" v-if="showDropdown">
                    <div class="vs-d-body">
                        <div class="vs-form-group">
                            <div class="row">
                                <div class="col">
                                    <label class="vs-filter-label">{{ $t('Date From') }}</label>
                                    <BsDatePicker v-model:value="form.date_from"
                                                    value-type="format"
                                                    format="DD.MM.YYYY"
                                ...
                                <div class="col">
                                    ...
                                    <BsDatePicker v-model:value="form.date_to"
                                                    value-type="format"
                                                    format="DD.MM.YYYY"
                                                    placeholder="DD.MM.YYYY"
                                                    @change="inputChanged"
...
import {ref} from "vue";
    ...
    const form = ref({date_from: '', date_to: ''});
