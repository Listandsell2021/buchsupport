        ...
        <div class="modal-dialog" v-on-click-outside="onClickOutsideHandler">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $t('Edit Appointment') }}</h5>
...
const form = ref(getFormData(props.appointment));
...
function updateLeadAppointment() {
    axios.post(route('admin.lead.appointment.update'), form.value)
        .then((response) => {
...
function getFormData(appointment) {

    appointmentStartDate.value = moment(appointment.start_at).toDate();
