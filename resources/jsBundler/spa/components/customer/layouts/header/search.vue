      ...
      <div class="Typeahead Typeahead--twitterUsers">
        <div class="u-posRelative">
          ...
          <div class="spinner-border Typeahead-spinner" role="status">
            ...
            <i class="fa fa-close close-search" @click="search_close()"></i>
        </div>
          ...
          <div class="ProfileCard u-cf" v-for="(menuItem, index) in menuItems.slice(0, 8)" :key="index">
            <div class="ProfileCard-avatar header-search">
              ...
              <svg class="stroke-icon">
                <use :xlink:href="'assets/frontend/svg/icon-sprite.svg' + `#${menuItem.icon}`"></use>
              </svg>
            </div>
            ...
            <div class="ProfileCard-details">
              <div class="ProfileCard-realName">
                <span @click="removeFix()">
                  <router-link :to="menuItem.path" class="realname">
...
import { useMenuStore } from '@/storage/store/customer_menu';
